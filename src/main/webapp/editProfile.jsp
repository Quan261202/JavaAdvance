...
<body>
			...
			<div class="col-md-3 border-right">
				<div
					...
					<img class="rounded-circle mt-5" width="150px"
						src="${customer.avatar}"><span
						class="font-weight-bold">${customer.lastName}</span><span class="text-black-50">${customer.email }</span><span>
					</span>
				</div>
			</div>
					...
					<div class="row mt-2">
						<div class="col-md-6">
							<label class="labels">Name</label><input type="text"
								class="form-control" placeholder="first name" value="${customer.firstName }">
						</div>
						<div class="col-md-6">
							<label class="labels">Surname</label><input type="text"
								class="form-control" value="${customer.lastName }" placeholder="enter your last name">
						</div>
					</div>
					<div class="row mt-3">
						<div class="col-md-12">
						...
						<div class="col-md-12" id="province">
						...
						<div class="col-md-12" id="ward">
							<label class="labels">Ward</label>
							<select class="selectpicker show-tick form-control">
	...
	<script type="text/javascript">
		//fetch('${urlAPI}').then(res =>{
			//return res.json();
		//}).then(data=>{
			//console.log(JSON.parse(data).district[1])
		//})
	</script>
</body>
</html>